class Jogador {
    constructor({
        ...
        this.image.src = "./img/max" + this.frame.estado + this.controle.dirX + this.frame.value + ".png"
    ...
    draw() {
        this.ctx.drawImage(this.image, 0, 0, this.spritew, this.spriteh, this.position.x, this.position.y, this.width, this.height)
    }
    ...
    upd(inimigos) {
        ...
        if (this.vida > 0) {
            if (this.controle.a) {
                ...
                this.frame.changeEstado("andando");
                this.veloci.x = 7
            } else if (this.controle.s) { //precisa adicionar max agachando
                this.frame.changeEstado("agachado");
                this.veloci.x = 0;
        ...
        // var barravida = document.querySelector(".vida")
        // barravida.style.width = this.vida / 5 + "vw"
    }
